...
const TabN5 = () => {
  const initialTableData = [
    ...
    { 
      title: "6. Organizing/Handling Training Programme for External Participants ",
      headers: ["SL. NO", "Name of Event handled","Date", "POINTS"],
      data: [
        { slno: 1, event6: '',Date6:'', points6: '' },
        { slno: 2, event6: '',Date6:'', points6: '' },
        { slno: 3, event6: '',Date6:'', points6: '' }
      ]
    },
  ...
  return (
    <section className="py-1 bg-blueGray-50 " style={{ width: '97%' }}>
      <h1 className="font-semibold text-3xl text-blueGray-700 text-center">assistant service-1</h1>
